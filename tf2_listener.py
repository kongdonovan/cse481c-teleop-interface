...
class FrameListener():
    ...
    def __init__(self):
        ...
        self.from_frame_rel = 'link_mast'
        self.to_frame_rel = 'fk_link_lift'
    ...
    def get_pos(self):
        ...
        trans = self.tf_buffer.lookup_transform(self.to_frame_rel,
                                                   self.from_frame_rel,
                                                   rospy.Time())
        
        return trans.transform

    def get_pos_extend(self):
        rospy.sleep(1.0)

        # We're going to publish information at 1 Hz
        rate = rospy.Rate(1)

        trans = self.tf_buffer.lookup_transform("fk_link_arm_l0",
                                                   "link_lift",
                                                   rospy.Time())
    ...
    def get_grip(self):
        ...
        trans = self.tf_buffer.lookup_transform("link_gripper_fingertip_left",
